...
import ImageViewer from "@/components/Sider/ImageViewer";
    ...
    >
      <div className="w-full max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col gap-4 p-4 md:p-6">
          ...
          <div>
            <p className="text-md font-semibold mb-2">Utilities Include</p>
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-4 flex-wrap">
              <a
                ...
                "
              >
                <MapPlus className="mr-2 text-blue-500" />
                Click Locate
              </a>
          ...
          <div className="border-dashed border-[1px] rounded-xl p-2">
      ...
      <footer className="fixed bg-[#09090B] bottom-0 gap-2 left-0 w-full border-t p-4 flex justify-end items-center">
